# 🤖 Geist-AI — Local AI powered by Ollama
...
| `/bots` | Show all bots |
| `/memory` | Show what Geist remembers about you |
| `/forget` | Clear memory |
...
In Geist-AI → Sidebar → **🔗 Agent Network** → enter the IP of PC 2 → click Test.

Geist-AI automatically routes image requests to the Vision Agent!

---

## 🧠 How the Self-Learning Works

- Geist remembers facts you tell it (your name, job, interests)
